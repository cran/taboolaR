...
## Analyzing Taboola marketing data 

Now we can analyze data from Taboola data. For instance, let's compare the two campaigns we have to see which one performed better the last 100 days. 
